...
class Test(unittest.TestCase):
    ...
    def test08(self):
        sequence ='1111111111111111111111111111111100000000000000000000'
        compress = hw6.compress(sequence)
        self.assertEqual(compress, '0000011111000000000110100')
        uncompress = hw6.uncompress(compress)
        self.assertEqual(uncompress, sequence)
        self.assertAlmostEqual(hw6.compression(sequence), 0.48076, 4)
